...
namespace MotorsportSim.General
{
    internal class MenuUI
    {
        ...
        private static readonly Color BlackText = Color.FromArgb(0, 0, 0);
        ...
        public static void RaceForm(Form frm)
        {
            Form(frm);
            //frm.MinimumSize = new Size(1000, 600);
